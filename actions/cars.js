...
export async function processCarImageWithAI(file) {
  try {
    ...
    const prompt = `
      ...
      6. Mileage as a string (your best guess, don't include any symbols or commas)
      7. Fuel type (your best guess)
      8. Transmission type (your best guess)
      9. Price as a string (your best guess, don't include any currency symbols or commas)
